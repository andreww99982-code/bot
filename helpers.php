...
function t(string $key, string $lang, array $vars = []): string
{
    ...
    $map = [
        'ru' => [
            ...
            'referral_title' => "🤝 Партнёрская программа\n\nПриглашайте друзей и получайте {percent}% от каждого пополнения их баланса!\n\n👥 Приглашено: {count} чел.\n💰 Заработано: {earned}\n\n🔗 Ваша реферальная ссылка:\n{link}",
            'referral_fallback' => "Ваш ID реферера: {user_id}\nСсылка: https://t.me/НАСТРОЙТЕ_USERNAME_БОТА?start=ref_{user_id}",
            'choose_lang_account' => 'Выберите язык интерфейса:',
        ...
        'en' => [
            ...
            'referral_title' => "🤝 Referral Program\n\nInvite friends and get {percent}% from each of their balance top-ups!\n\n👥 Invited: {count}\n💰 Earned: {earned}\n\n🔗 Your referral link:\n{link}",
            'referral_fallback' => "Your referrer ID: {user_id}\nLink: https://t.me/SET_BOT_USERNAME?start=ref_{user_id}",
            'choose_lang_account' => 'Choose interface language:',
