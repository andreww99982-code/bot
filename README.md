...
### Каталог
- показывает только корневые категории и количество доступных товаров
- если у категории есть подкатегории — сначала показывает их
- товары показываются в выбранной конечной категории: название, цена, остаток
- покупка:
  - проверка баланса
...
### Разделы
- 📦 Категории: создание (RU/EN), выбор родителя (подкатегории), иерархический список, удаление (если нет подкатегорий и товаров)
...
- ⚙️ Настройки: username администратора + тексты раздела помощи (RU/EN)
- 📊 Статистика: пользователи, продажи, выручка, последние 10 покупок
- Toast-уведомления (успех/ошибка) отображаются в правом нижнем углу
